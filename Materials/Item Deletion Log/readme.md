...
### 6.1 Master structural deletion log (item × technology × criterion)
...
Residual MI / dependence `deontology06` ~~ `deontology07`: NPP .34; HM .40; SAI .45. Judgmental note: nature-focused content redundancy (local dependence).
...
Example residual flags involving `hedonism09`: with `hedonism07` (health) MI-implied dependence NPP .72, HM .33, SAI .31; also with pleasure-related items.
...
### 6.2 Compact decision summary (structural)
