...
var boolSkipAffectImgNano = true;
var boolSkipAffectImgMS = true;
...
/* Affective Imagery: */
// #1
const AffectiveImageryNano_htmlForm = new lab.html.Form({
  title: "AffectiveImageryNano",
  content: textObj.AffectiveImageryNano,
  messageHandlers: {
    run: () => {
      var timesClicked = 1;
      ...
      $(function () {
        ...
        $("#submitAssoButton").on("click", () => {
          ...
          if (document.querySelector(currentElement).value.replace(/[^a-zA-Z]+/g, '').length > 0) {
            ...
            toastr.warning("Click on next response or Enter if you have entered a word.", "Please enter at least one word.", {
              closeButton: true,
              timeOut: 2000,
...
const AffectiveImageryAffectNano_htmlForm = new lab.html.Page({
  title: "AffectiveImageryAffectNano",
  tardy: true,
  skip: "${boolSkipAffectImgNano}",
  items: [{
    required: true,
    type: "likert",
    items: [{
...
// #2
const AffectiveImageryMS_htmlForm = new lab.html.Form({
  title: "AffectiveImageryMS",
  content: textObj.AffectiveImageryMS,
  messageHandlers: {
    run: () => {
      var timesClicked = 1;
      const placeholderLabel = ["second", "third", "fourth", "fifth"];
...
const AffectiveImageryAffectMS_htmlForm = new lab.html.Page({
  title: "AffectiveImageryAffectMS",
  tardy: true,
  skip: "${boolSkipAffectImgMS}",
  items: [{
    required: true,
    type: "likert",
    items: [{
...
const quesCertaintySAI_htmlForm = new lab.html.Page({
  ...
  items: [{
    ...
    label: "Evaluate how confident you are in your opinion about the Nano-Pat-Parka. ",
...
const quesMoralIntensitySAI_htmlForm = new lab.html.Page({
  ...
  items: [{
    ...
    label: "Imagine that in a few years' time, people are faced with the decision to use the Nano-Pat-Parka.",
...
const EndingScreen_htmlScreen = new lab.html.Screen({
  ...
  <div>
  <div>
  NanoTec is a purely fictitious company and there is no such technology as the Nano-Pat-Parka. We only chose this example to ask for your attitudes towards such a fictitious technology with specific properties. 
  </div>
  <br>
  <br>
  ...
  messageHandlers: {
    ...
    epilogue: function anonymous() {
      if (typeof jatos.jQuery === "function") {
        ...
        // then redirect
        jatos.endStudyAndRedirect("https://app.prolific.co/submissions/complete?cc=5A9B5C08", true, "everything worked fine");
      }
    }
  },
})
...
const study = new lab.flow.Sequence({
  ...
  content: [
    ...
    AffectiveImageryNano_htmlForm,
    AffectiveImageryAffectNano_htmlForm,
    AffectiveImageryMS_htmlForm,
    AffectiveImageryAffectMS_htmlForm,
