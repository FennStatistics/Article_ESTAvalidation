...
let quesUncertaintySAI = {
  ques: ["I have a clear opinion about the Nano-Pat-Parka.",
    "I know how to think about the possible use of the Nano-Pat-Parka.",
    "Overall, I am very sure about my opinion of the Nano-Pat-Parka."
  ],
  scale: ["1", "2", "3"]
}
...
let quesMoralIntensitySAI = {
  ques: ["The negative consequences (if any) using the Nano-Pat-Parka will be very serious.",
    "The overall harm (if any) using the Nano-Pat-Parka will be very small.",
    "There is a very small likelihood that using the Nano-Pat-Parka will actually cause any harm.",
    "Using the Nano-Pat-Parka is likely to cause harm.",
    "Using the Nano-Pat-Parka will not cause any harm in the immediate future.",
    "The negative effects (if any) using the Nano-Pat-Parka will be felt very quickly.",
    "People are not likely to agree about whether using the Nano-Pat-Parka was right or wrong.",
    "Most people would agree if it is appropriate to use the Nano-Pat-Parka.",
    "The harmful consequences (if any) using the Nano-Pat-Parka will be concentrated on a small number of people.",
    "Any negative effects using the Nano-Pat-Parka will be spread across a large number of individuals."
  ],
